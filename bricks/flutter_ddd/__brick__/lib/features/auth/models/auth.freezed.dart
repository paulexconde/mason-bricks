...
abstract class $AuthCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String email, String? accessToken, String? refreshToken});
}
...
class _$_Auth implements _Auth {
  ...
  @override
  String toString() {
    return 'Auth(id: $id, email: $email, accessToken: $accessToken, refreshToken: $refreshToken)';
  }
...
abstract class _Auth implements Auth {
  factory _Auth(
      ...
      final String? accessToken,
      final String? refreshToken}) = _$_Auth;
